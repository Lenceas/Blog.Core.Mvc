            ...
            try
            {
                ...
                if (AppSettings.app(new string[] { "AppSettings", "SeedDBData" }).ObjToBool())
                {
                    ...
                    if (!context.administrators.Any())
                    {
                        ...
                        {
                        new Administrator{ Guid=Guid.NewGuid().ToString("N"),UserName="admin",UserPwd="admin888",Status=1,SortId=100 },
                        new Administrator{ Guid=Guid.NewGuid().ToString("N"),UserName="lujiesheng",UserPwd="admin888",Status=1,SortId=100 }
                        };
